...
public class CustomBitmapFont
{
    ...
    public function CustomBitmapFont(texture:Texture=null, fontXml:XML=null)
    {
        mName = "unknown";
    ...
    public function fillQuadBatch(
        quadBatchUnselected:QuadBatch,
        quadBatchSelected:QuadBatch,
        width:Number, height:Number, text:String,
        fontSize:Number=-1,
        color:uint=0xffffff,
        selectionColor:uint=0xffffff,
